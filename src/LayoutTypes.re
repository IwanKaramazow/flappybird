...
let pretty_print name {left, top, right, bottom, width, height} => {
  print_endline "===============";
  print_endline @@ "     =====> " ^ name;
  print_endline @@ "Left: " ^ string_of_int left;
  print_endline @@ "Top: " ^ string_of_int top;
  print_endline @@ "Right: " ^ string_of_int right;
  print_endline @@ "Bottom: " ^ string_of_int bottom;
